...
const props = defineProps<DialogContentPropsExtended>();
...
<template>
  <DialogPortal>
    <DialogOverlay
      class="data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-gray-900/40 backdrop-blur-xs"
    />
    <DialogContent
      v-bind="forwarded"
      :class="
